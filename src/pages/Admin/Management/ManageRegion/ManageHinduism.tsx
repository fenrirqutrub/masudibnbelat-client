...
const fetch = (page: number, search = "") =>
  axiosPublic
    .get<Resp>("/api/article-hinduism", {
      params: { page, limit: PAGE_SIZE, search },
    })
    .then((r) => r.data);

const del = (id: string) =>
  axiosPublic.delete(`/api/article-hinduism/${id}`).then((r) => r.data);

/* ── Component ── */
const ManageHinduism = () => {
    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
      ...
      >
        <div className="flex-1">
          <div>
            <h2 className="text-2xl font-bold mb-2">Articles hinduism</h2>
          </div>
