...
const fetch = (page: number, search = "") =>
  axiosPublic
    .get<Resp>("/api/article-buddhism", {
      params: { page, limit: PAGE_SIZE, search },
    })
    .then((r) => r.data);

const del = (id: string) =>
  axiosPublic.delete(`/api/article-buddhism/${id}`).then((r) => r.data);

/* ── Component ── */
const ManageBuddhism = () => {
    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
      ...
      >
        <div className="flex-1">
          <h2 className="text-2xl font-bold mb-2">Articles buddhism</h2>
          <input
            placeholder="Search..."
            value={search}
            onChange={(e) => {
