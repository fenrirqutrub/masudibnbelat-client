...
const fetch = (page: number, search = "") =>
  axiosPublic
    .get<Resp>("/api/article-travel", {
      params: { page, limit: PAGE_SIZE, search },
    })
    .then((r) => r.data);

const del = (id: string) =>
  axiosPublic.delete(`/api/article-travel/${id}`).then((r) => r.data);

/* ── Component ── */
const ManageArticleTravel = () => {
...
export default ManageArticleTravel;
