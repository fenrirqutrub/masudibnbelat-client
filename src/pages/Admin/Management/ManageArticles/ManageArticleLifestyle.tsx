...
const fetch = (page: number, search = "") =>
  axiosPublic
    .get<Resp>("/api/article-lifestyle", {
      params: { page, limit: PAGE_SIZE, search },
    })
    .then((r) => r.data);

const del = (id: string) =>
  axiosPublic.delete(`/api/article-lifestyle/${id}`).then((r) => r.data);

/* ── Component ── */
const ManageArticleLifestyle = () => {
    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
      ...
      >
        <div className="flex-1">
          <h2 className="text-2xl font-bold mb-2">Articles Lifestyle</h2>
          <input
            placeholder="Search..."
            value={search}
            onChange={(e) => {
...
export default ManageArticleLifestyle;
