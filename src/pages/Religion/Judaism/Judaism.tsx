...
import JudaismSearch from "./JudaismSearch";
import JudaismCard from "./JudaismCard";
...
const Judaism = () => {
  ...
  const {
    ...
    queryKey: ["judaism-articles"],
    queryFn: async () => {
      const res = await axiosPublic.get<ApiResponse>("/api/article-judaism", {
  ...
  return (
    <div className="py-8 px-4 sm:px-6 lg:px-8 min-h-screen bg-gray-50 dark:bg-[#0D0E14]">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Search Bar */}
        <JudaismSearch onSearch={setSearchQuery} />
