...
import IslamicSearch from "./IslamicSearch";
...
const Islamic = () => {
  ...
  const {
    ...
    queryKey: ["islamic-articles"],
    queryFn: async () => {
      const res = await axiosPublic.get<ApiResponse>("/api/article-islamic", {
  ...
  return (
    <div className="py-8 px-4 sm:px-6 lg:px-8 min-h-screen bg-gray-50 dark:bg-[#0D0E14]">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Search Bar */}
        <IslamicSearch onSearch={setSearchQuery} />
