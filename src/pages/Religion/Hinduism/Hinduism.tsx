...
import HinduismSearch from "./HinduismSearch";
import HinduismCard from "./HinduismCard";
...
const Hinduism = () => {
  ...
  const {
    ...
    queryKey: ["hinduism-articles"],
    queryFn: async () => {
      const res = await axiosPublic.get<ApiResponse>("/api/article-hinduism", {
  ...
  return (
    <div className="py-8 px-4 sm:px-6 lg:px-8 min-h-screen bg-gray-50 dark:bg-[#0D0E14]">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Search Bar */}
        <HinduismSearch onSearch={setSearchQuery} />
