...
const Technology = () => {
  ...
  // ── FETCH ALL ARTICLES WITHOUT PAGE/LIMIT ────────────────
  // Technology.tsx, useQuery অংশ
const {
  data: articlesData,
  isLoading,
  isError,
  ...
  queryKey: ["technology-articles"],
  queryFn: async () => {
    const res = await axiosPublic.get<ApiResponse>(
      "/api/articles", // Change this
      {
        params: { 
          categorySlug: "technology", // Add categorySlug filter
          limit: 1000, 
          page: 1 
        },
      }
          ...
          <AnimatePresence mode="popLayout">
            {currentItems.length === 0 ? (
              ...
              currentItems.map((article, index) => (
                ...
                >
                  <TechnologyCard article={article} />
                </motion.div>
              ))
            )}
          </AnimatePresence>
