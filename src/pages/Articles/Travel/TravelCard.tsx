...
const TravelCard = ({ article }: TechnologyCardProps) => {
  return (
    <Link
      to={`/articles/travel/${article._id}`}
      state={{ article }}
      className="group block"
    >
      <div className=" rounded overflow-hidden transition-all duration-500 border border-gray-200 dark:border-slate-800 h-full flex flex-col rubik-regular bg-white dark:bg-slate-900 hover:shadow-lg">
